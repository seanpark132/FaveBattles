...
export default function GameSetup({
  ...
  return (
    <section
      className={`m-6 mt-16 w-full max-w-screen-md rounded border-transparent p-4 ${
      ...
      <form onSubmit={handleGameStart}>
        <div className="flex">
          <select
            ...
            id="startingOptions"
            className={`mx-2 flex-1 rounded border-transparent p-2 text-center text-lg font-semibold ${
          ...
          <button
            className={`mx-2 flex-1 rounded border-transparent p-2 text-lg ${
