...
export default function EditGame({ gameData }) {
  ...
  const [selectedCategories, setSelectedCategories] = useState(gameData.categories);   
  ...
  async function handleSubmit(event) {
      ...
      try {
        ...
        await setDoc(doc(db, FIRESTORE_COLLECTION_NAME, gameData.gameId), fullFormData);        
        alert("Game Updated!");        

      } catch(error) {
        console.error(error.message);
        alert("An error has occured while updating your game. Please try again.")
      };       
  };  
    ...
    <div className="w-full">
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <div className="flex flex-col w-full items-center px-6 mt-8">                                             
            <div className={gameData.gameType === "image" ?  "create-new-img-container": "create-new-video-container"}>
